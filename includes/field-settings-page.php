...
function wc_avito_fields_page() {
            ...
            <table class="widefat fixed striped">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <input type="checkbox" name="global_fields[<?php echo $index; ?>][enabled]" value="1" <?php checked(!empty($field['enabled']), true); ?> aria-label="Включить поле <?php echo esc_attr($field['xml_tag']); ?>" />
                            </td>
                            <td>
                            ...
                            <td>
                                <button type="button" class="button delete-field" data-section="global" data-index="<?php echo $index; ?>" aria-label="Удалить поле <?php echo esc_attr($field['xml_tag']); ?>">×</button>
                            </td>
                        </tr>
                    <?php 
                        endforeach;
            ...
            <table class="widefat fixed striped">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <input type="checkbox" name="category_fields[<?php echo $index; ?>][enabled]" value="1" <?php checked(!empty($field['enabled']), true); ?> aria-label="Включить поле <?php echo esc_attr($field['xml_tag']); ?>" />
                            </td>
                            <td>
                            ...
                            <td>
                                <?php if ($field['type'] === 'textarea'): ?>
                                    <textarea name="category_fields[<?php echo $index; ?>][default_value]" rows="3" class="large-text" placeholder="Значение по умолчанию..." title="Используется, если поле не заполнено у категории" aria-label="Общее значение"><?php echo esc_textarea($default_value); ?></textarea>
                                <?php elseif ($field['type'] === 'checkbox'): ?>
                                    <input type="checkbox" name="category_fields[<?php echo $index; ?>][default_value]" value="1" <?php checked($default_value, '1'); ?> title="Значение по умолчанию" aria-label="Общее значение" />
                                <?php else: ?>
                                    <input type="<?php echo esc_attr($field['type']); ?>" name="category_fields[<?php echo $index; ?>][default_value]" value="<?php echo esc_attr($default_value); ?>" class="regular-text" placeholder="Значение по умолчанию..." title="Используется, если поле не заполнено у категории" aria-label="Общее значение" />
                                <?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <button type="button" class="button delete-field" data-section="category" data-index="<?php echo $index; ?>" aria-label="Удалить поле <?php echo esc_attr($field['xml_tag']); ?>">×</button>
                            </td>
                        </tr>
                    <?php 
                        endforeach;
            ...
            if (section === 'global') {
                ...
                row = '<tr>' +
                    ...
                    '<td>' +
                        ...
                        '<input type="hidden" name="' + section + '_fields[' + index + '][key]" value="" />' +
                    '</td>' +
                    '<td><input type="text" name="' + section + '_fields[' + index + '][default_value]" value="" class="regular-text" placeholder="Общее значение" aria-label="Общее значение" /></td>' +
                    '<td><select name="' + section + '_fields[' + index + '][type]" aria-label="Тип поля">' +
                        '<option value="text">Text</option>' +
                        '<option value="textarea">Textarea</option>' +
                        '<option value="number">Number</option>' +
    ...
    .delete-field:focus {
        ...
        box-shadow: 0 0 0 2px #2271b1; /* WordPress blue focus ring */
    }
