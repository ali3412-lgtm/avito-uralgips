                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="button delete-field" data-section="global" data-index="<?php echo $index; ?>" aria-label="Удалить поле" title="Удалить поле">×</button>
                            </td>
                        </tr>
                    <?php
                        endforeach;
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="button delete-field" data-section="category" data-index="<?php echo $index; ?>" aria-label="Удалить поле" title="Удалить поле">×</button>
                            </td>
                        </tr>
                    <?php 
                        endforeach;
