...
5. При необходимости добавьте **пользовательские XML-поля** для этой категории
...
- При включении этого режима для каждого товара появится чекбокс **"Экспорт на Avito"**
- Товар будет экспортирован только если:
  - ✅ Его категория включена в экспорт
  - ✅ **И** у самого товара установлен флаг "Экспорт на Avito"
- По умолчанию режим отключен (экспортируются все товары из включенных категорий)
